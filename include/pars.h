...
** Last update Sun May 12 01:32:27 2013 karina martynava
*/
...
typedef	struct s_pars_kind
{
  char	*str;
  void	(*ptr)(t_ext *, t_obj **, char *);
} t_pk;
