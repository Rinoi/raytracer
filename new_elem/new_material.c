...
** Last update Sat Jun  8 21:04:07 2013 louis martin-pierrat
*/
#include	"rt.h"
...
void		new_material(t_mat **material, t_rs *rs, struct s_xml *tree)
{
  ...
  get_fvalue(tree, "bump", &new->bump) == FAIL ? new->bump = 0 : 0;
  ...
  get_fvalue(tree, "indice", &new->indice) == FAIL ? new->indice = 0 : 0;
